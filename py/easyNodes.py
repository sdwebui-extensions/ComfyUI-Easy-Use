...
class applyPowerPaint:
    ...
    def apply(self, pipe, image, mask, powerpaint_model, powerpaint_clip, dtype, fitting, function, scale, start_at, end_at, save_memory='none'):
        ...
        if powerpaint_clip in backend_cache.cache:
            ...
            base_clip = get_local_filepath(model_url, os.path.join(folder_paths.models_dir, 'clip'), cache_dir="/stable-diffusion-cache/models/clip", local_file_name="sdv15_clip.safetensors")
...
class applyInpaint:
    ...
    def get_powerpaint_model(self, model):
        ...
        from urllib.parse import urlparse
        get_local_filepath(powerpaint_model, os.path.join(INPAINT_DIR, 'powerpaint'), cache_dir="/stable-diffusion-cache/models/inpaint/PowerPaint-v2-1")
    ...
    def load_model(self, model, preset, lora_model_strength, provider="CPU", clip_vision=None, optional_ipadapter=None, cache_mode='none', node_name='easy ipadapterApply'):
        ...
        if not clip_vision:
            ...
            if clipvision_file is None:
                if preset.lower().startswith("regular"):
                    ...
                    clipvision_file = get_local_filepath(model_url, IPADAPTER_DIR, "clip-vit-h-14-laion2B-s32B-b79K.safetensors", cache_dir="/stable-diffusion-cache/models/clip")
        ...
        if not ipadapter:
            ...
            if ipadapter_file is None:
                ...
                ipadapter_file = get_local_filepath(model_url, IPADAPTER_DIR, local_file_name, cache_dir="/stable-diffusion-cache/models/ControlNet")
